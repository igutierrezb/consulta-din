...
const searches={groups:'',tutors:'',rooms:'',locate:''};
...
function setMode(value){
 ...
 $('horarios').hidden=!schedule;$('careerWrap').hidden=!['groups','tutors','locate'].includes(value);
 if(schedule){DIN_SCHEDULE.mount(value,$('horarios'),{reset:value==='grupos'});return;}
 DIN_SCHEDULE.cancel();if(value==='locate'){$('career').value='';searches.locate='';}if(value==='tutors'){$('career').value='';searches.tutors='';}$('search').value=searches[value]||'';
